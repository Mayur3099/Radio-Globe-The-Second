...
const NavBar = () => {
    return (
        <div className='flex justify-between py-2 px-8 bg-gradient-to-b from-gray-900 via-purple-900 to-violet-600 border-b'>
            ...
            <Link className='flex mt-2 w-full text-white font-bold text-4xl'
                to="/">
            ...
            <div className='flex justify-end mt-2 py-4 px-3 w-full text-white font-bold text-xl'>
                ...
                <Link to='/about' className='flex flex-col items-center justify-center mx-8'>
                ...
                <Link to='contact' className='flex flex-col items-center justify-center ml-8'>
